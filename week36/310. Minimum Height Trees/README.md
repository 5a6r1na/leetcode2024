...
📎 Link: [Minimum Height Trees](https://leetcode.com/problems/minimum-height-trees/description/)<br>
🟠 Difficulty: Medium<br>
👩🏻‍💻 Topics: Depth-First Search, Breadth-First Search, Graph, Topological Sort<br>
